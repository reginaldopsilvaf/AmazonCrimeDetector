...
from .algorithms.CrimesFronteirasAmazonia.IdentificadorCrimes import IdentificadorCrimesFronteiras

class IdentificadorCrimesFronteirasProvider(QgsProcessingProvider):
    ...
    def loadAlgorithms(self):
        ...
        """
        self.addAlgorithm(IdentificadorCrimesFronteiras())
    ...
    def name(self):
        ...
        """
        return self.tr('Identificador de Crimes Transfronteiriços com IA')
